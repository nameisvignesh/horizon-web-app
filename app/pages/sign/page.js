...
const Sign = () => {
  ...
  const handleSubmit = (e) => {
    ...
    router.push('/pages/request/signedin'); // Change this to your desired route
  };
  ...
  return (
    <div className='flex flex-col place-items-center min-h-screen'>
      ...
      />
      <form onSubmit={handleSubmit} className='flex flex-col items-center gap-3 mt-20 bg-gray-200 px-6 py-8 sm:px-12 sm:py-10 rounded-3xl w-full sm:w-96'>
        <h1 className='text-red-500 font-bold text-3xl'>Sign Up</h1>
        <input 
        ...
        <Link className='text-red-500 underline' href='/pages/login'>
